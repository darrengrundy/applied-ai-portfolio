...
import_data = {
    ...
    "assets": {
        ...
        "utterances": [
            ...
            {
                "text": "what is time in newyork now?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
        ...
        {
                "text": "What about time in London Now?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
                    ...
                    {
                "text": "Any idea about time in Perth?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
                    ...
                    {
                "text": "Do we what time is in Japan?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
                    ...
                    {
                "text": "Tell me about time in Delhi",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
                    ...
                    {
                "text": "Do you anything about time in sydney now?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
                    ...
                    {
                "text": "What time is in sydney now?",
                "language": "en",
                "intent": "GetTime",
                "entities": [
                    {
